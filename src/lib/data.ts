...
const RelianceLogo = (props: { className?: string }) => (
...
const TcsLogo = (props: { className?: string }) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const HdfcLogo = (props: { className?: string }) => (
    <svg {...props} viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
const InfosysLogo = (props: { className?: string }) => (
...
const IciciLogo = (props: { className?: string }) => (
  <svg {...props} role="img" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
